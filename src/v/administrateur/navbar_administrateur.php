<div class="navbar">
    <div class="header2">
        <div class="right">
            ...
            <a href="index.php"><img
                    ...
                    alt="Image Retour au Menu" width="50" height="50"></a>
        </div>
        <div style="text-align: right;">
            <a href="?deconnexion=true"><img src="https://image.flaticon.com/icons/png/512/130/130925.png"
                    alt="Image Retour au Menu" width="50" height="50"></a>
    ...
    <a href="identifiantto:prof@trionfini.com">
        <button>
